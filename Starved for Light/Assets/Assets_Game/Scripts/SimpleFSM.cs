...
public class SimpleFSM : MonoBehaviour {
	...
	void EnterState(State stateEntered)
	{
		...
		case State.Patrol:
			...
			_transform.GetComponent<Renderer>().material.color = Color.green;
		...
		case State.Investigate:
			...
			_transform.GetComponent<Renderer>().material.color = Color.yellow;
		...
		case State.Alert:
			...
			_transform.GetComponent<Renderer>().material.color = Color.red;
